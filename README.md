...
Then, just browse to [mlocal.xkcd.com](http://mlocal.xkcd.com) and you are ready to start developing!
...
Remember to put all domains you're going to hit in your etc/hosts or to run your server with the `-auto-hosts=true` option.
    ...
    127.0.0.1   mlocal.xkcd.com
    127.0.0.1   mlocal.imgs.xkcd.com
    127.0.0.1   mlocal.what-if.xkcd.com
    127.0.0.1   mlocal.blag.xkcd.com
    127.0.0.1   mlocal.store.xkcd.com
    127.0.0.1   mlocal.dynamic.xkcd.com
